...
import com.cda25.springboot.square_games.entities_do.GameParamsWithRange;
import com.cda25.springboot.square_games.entities_do.TokenPosMove;
import com.cda25.springboot.square_games.plugin.GamePlugin;
...
public class GameServiceImpl implements GameService {
    ...
    public Game createGame(final GameParams gameCreationParams) {
        ...
        Game game = null;
        if (gamePlugin != null) {
            game = gamePlugin.createGame(gameCreationParams);
